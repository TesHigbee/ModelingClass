...
//Name: chairbrown.ma
//Last modified: Mon, May 22, 2023 04:52:29 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "02D3AB35-4230-F0F8-04BC-07BA0BCCD2F1";
createNode transform -s -n "persp";
	rename -uid "16BF5C2D-4415-7F9A-F234-7492D589F3B4";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.8302209912152319 6.0865974721151517 18.499658874706444 ;
	setAttr ".r" -type "double3" -6.3383527307525727 -8.1999999999997097 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F4075DF0-4325-A6B3-0871-95B78DDB08D3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.680263865394796;
...
createNode transform -n "leg1" -p "seat1";
...
createNode mesh -n "leg" -p "leg1";
	...
	setAttr ".pv" -type "double2" 0.5 0.64823639392852783 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 54 ".uvst[0].uvsp[0:53]" -type "float2" 0.61048543 0.04576458
		 ...
		 0.84375 0.5 0.15625 0.5 0.84375 0.53125 0.35972375 0.5 0.35972375 0.46875 0.35972375
		 0.4375 0.35972375 0.40625 0.35972375 0.625 0.35972375 0.375 0.35972375 0.59375 0.35972375
		 0.5625 0.35972375 0.5 0.64823639 0.46875 0.64823639 0.4375 0.64823639 0.40625 0.64823639
		 0.625 0.64823639 0.375 0.64823639 0.59375 0.64823639 0.5625 0.64823639 0.53125 0.64823639;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt[26:33]" -type "float3"  0.1167855 0 1.7763568e-15 
		0.29413041 0 1.722539e-15 0.1167855 0 1.7763568e-15 0 0 1.7763568e-15 -0.1167855 
		0 1.7763568e-15 -0.29413041 0 1.722539e-15 -0.11678559 0 1.7763568e-15 0 0 1.7763568e-15;
	setAttr -s 34 ".vt[0:33]"  0.70710671 -4.13124275 -0.70710671 -7.1942452e-14 -4.13124275 -0.99999988
		 ...
		 -7.1942452e-14 11.67452621 1.4921397e-13 -7.1942452e-14 -2.14082289 0.99999994 -0.81145722 -2.14082289 0.70710671
		 -1.25192511 -2.14082289 1.6263522e-13 -0.81145722 -2.14082289 -0.70710671 -7.1942452e-14 -2.14082289 -0.99999988
		 0.81145722 -2.14082289 -0.70710671 1.25192499 -2.14082289 1.4217565e-13 0.81145787 -2.14082289 0.70710677
		 -0.71960664 10.01961422 0.70710671 -1.030177593 10.01961422 1.5982578e-13 -0.71960664 10.01961422 -0.70710671
		 -7.1942452e-14 10.01961422 -0.99999988 0.71960664 10.01961422 -0.70710671 1.030177593 10.01961422 1.3936622e-13
		 0.71960676 10.01961422 0.70710677 -7.1942452e-14 10.01961422 0.99999994;
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "leg3" -p "seat1";
	...
	setAttr ".sp" -type "double3" 0 -4.131242596553677 -0.99999992548670846 ;
	setAttr ".spt" -type "double3" 0 3.3303989718915532 0.80614939594949353 ;
createNode transform -n "leg2" -p "seat1";
	...
	setAttr ".rp" -type "double3" 0 -0.80084362466212367 -0.19385052953721471 ;
	setAttr ".sp" -type "double3" 0 -4.1312425965536761 -0.99999992548670669 ;
	setAttr ".spt" -type "double3" 0 3.3303989718915528 0.80614939594949198 ;
createNode transform -n "leg4" -p "seat1";
...
createNode transform -n "top1" -p "seat1";
...
createNode mesh -n "topShape1" -p "top1";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "back1" -p "seat1";
...
createNode mesh -n "backShape1" -p "back1";
	...
	setAttr ".pd[0]" -type "dataPolyComponent" Index_Data UV 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "back4" -p "seat1";
...
createNode transform -n "back5" -p "seat1";
...
createNode transform -n "back3" -p "seat1";
...
createNode transform -n "back2" -p "seat1";
	...
	setAttr ".sp" -type "double3" 0 -0.49999991900301444 0 ;
	setAttr ".spt" -type "double3" 0 -0.036896873477975906 0 ;
parent -s -nc -r -add "|seat1|leg1|leg" "leg3" ;
parent -s -nc -r -add "|seat1|leg1|leg" "leg2" ;
parent -s -nc -r -add "|seat1|leg1|leg" "leg4" ;
parent -s -nc -r -add "|seat1|back1|backShape1" "back2" ;
parent -s -nc -r -add "|seat1|back1|backShape1" "back3" ;
parent -s -nc -r -add "|seat1|back1|backShape1" "back4" ;
parent -s -nc -r -add "|seat1|back1|backShape1" "back5" ;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "67B32E2B-4268-7AE5-5BCF-49B450792F06";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "ABC2689D-4372-3190-C65E-79B0AEF3DAAD";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C6DBBE15-4195-8BBA-A7BC-B694C4525F6D";
createNode displayLayerManager -n "layerManager";
	rename -uid "939F916A-4F32-CF96-9995-AE96711840A8";
createNode displayLayer -n "defaultLayer";
	rename -uid "DB0F9E0B-4B7C-203C-4621-FA80A77F5A34";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "CA08E8E8-4C15-E003-3989-60B81989DECB";
...
connectAttr "|seat1|leg1|leg.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|leg3|leg.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|leg2|leg.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|leg4|leg.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|back1|backShape1.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|back2|backShape1.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|back3|backShape1.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|back4|backShape1.iog" "lambert2SG.dsm" -na;
connectAttr "|seat1|back5|backShape1.iog" "lambert2SG.dsm" -na;
