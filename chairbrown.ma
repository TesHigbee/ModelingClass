...
//Name: chairbrown.ma
//Last modified: Mon, May 22, 2023 04:59:28 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "B9B3054C-4831-1B00-D213-CC85B9CE523D";
createNode transform -s -n "persp";
	rename -uid "16BF5C2D-4415-7F9A-F234-7492D589F3B4";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.589068973351221 10.704138541573325 19.446510050918665 ;
	setAttr ".r" -type "double3" -15.33835273075478 -328.59999999999377 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F4075DF0-4325-A6B3-0871-95B78DDB08D3";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 24.807247200321598;
